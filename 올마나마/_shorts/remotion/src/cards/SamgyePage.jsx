...
import { PAGES } from "./pages_samgye";
...
export const SamgyePanel = ({ i = 0, top = 200, pop = 1 }) => (
  <Panel top={top} pop={pop}><Body p={PAGES[i] || PAGES[0]} /></Panel>
);

export const SamgyePage = ({ i = 0 }) => (
