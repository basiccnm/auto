...
import { EP, cost, ratio } from "./card_bburinkle";
...
export const 줄 = [
  { 글: "bhc 뿌링클", 크기: 128, 좌우: -12, 위아래: -78, 색: "검정", 폰트: "굵게" },
...
const ARGS = { hook: HOOK, label: 리본글, food: "food/k_mx7svo_01.png", fit: false, 소품, 화살표, 쪽지,
...
// 썸네일 Still (배경 포함)
export const ThumbBburinkle = () => <ThumbLayout {...ARGS} />;

// 🔴 쇼츠 첫 장면(훅)용 — **배경 없이 알맹이만.** talk_engine 이 배경을 이미 깔았다.
//    썸네일과 같은 부품을 쓰므로 둘이 절대 어긋나지 않는다.
export const ThumbCardBburinkle = () => <ThumbInner {...ARGS} />;

// ── 인트로 장면 — 캐릭터 등장 ────────────────────────────────
export const BburinkleIntro = () => (
