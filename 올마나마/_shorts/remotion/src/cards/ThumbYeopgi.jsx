// 엽기떡볶이편 썸네일 — 이거 얼마남아 3 (2026-07-26)
//
...
import { EP, cost, ratio } from "./card_yeopgi";
...
export const 줄 = [
  { 글: "엽기로제", 크기: 132, 좌우: -12, 위아래: -78, 색: "검정", 폰트: "굵게" },
...
const ARGS = { hook: HOOK, label: 리본글, food: "food/s12_01.png", fit: false, 소품, 화살표,
  // 로제떡볶이는 정사각 그림이라 그냥 두면 작다 — 1.35배로 키운다
  음식배율: 1, // 누끼 기준 자동정렬로 바뀌어 미세조정 불필요
  // 리본 글씨는 흰색(2026-07-25 지시)
  리본색: "#FFFFFF" };

// 썸네일 Still (배경 포함)
export const ThumbYeopgi = () => <ThumbLayout {...ARGS} />;

// 🔴 쇼츠 첫 장면(훅)용 — **배경 없이 알맹이만.** talk_engine 이 배경을 이미 깔았다.
//    썸네일과 같은 부품을 쓰므로 둘이 절대 어긋나지 않는다.
export const ThumbCardYeopgi = () => <ThumbInner {...ARGS} />;

// ── 인트로 장면 — 캐릭터 등장 ────────────────────────────────
export const YeopgiIntro = () => (
