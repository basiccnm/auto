// 데리버거편 판 — 여성향 톤 (2026-08-02)
// 🔴 ZicobaPage.jsx 와 골격이 같다. 판 데이터(pages_deri)만 다르다.
//    쇼츠는 DeriPanel 만 떼어 쓰고, 스틸(DeriPage)도 같은 걸 감싼다 → 화면이 갈라지지 않는다
...
export const DeriPanel = ({ i = 0, top = 200, pop = 1 }) => (
  <Panel top={top} pop={pop}><Body p={PAGES[i] || PAGES[0]} /></Panel>
);

export const DeriPage = ({ i = 0 }) => (
