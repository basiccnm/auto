...
export const 줄 = [
  { 글: "애플망고치즈설빙", 크기: 125, 좌우: -12, 위아래: -84, 색: "검정", 폰트: "굵게" },
  { 글: "원가는", 크기: 174, 좌우: -99, 위아래: 95, 색: "코럴", 폰트: "굵게" },
];

export const 소품 = [
  { 그림: "food/s14_13_dot.png", x: 245, y: -277, 크기: 180, 회전: -3 },
...
const ARGS = { hook: HOOK, label: 리본글, food: "bg/bingsu_top.png", fit: false, 소품, 화살표,
  // 리본 글씨는 흰색(2026-07-25 지시)
  리본색: "#FFFFFF" };

// 썸네일 Still (배경 포함)
export const ThumbBingsu = () => <ThumbLayout {...ARGS} />;

// 🔴 쇼츠 첫 장면(훅)용 — **배경 없이 알맹이만.** talk_engine 이 배경을 이미 깔았다.
//    썸네일과 같은 부품을 쓰므로 둘이 절대 어긋나지 않는다.
export const ThumbCardBingsu = () => <ThumbInner {...ARGS} />;

// ── 인트로 장면 — 캐릭터 등장 ────────────────────────────────
export const BingsuIntro = () => (
  <AbsoluteFill style={{ background: TONE.bg }}>
    <Img
      src={staticFile("bg/bingsu_top.png")}
      style={{
