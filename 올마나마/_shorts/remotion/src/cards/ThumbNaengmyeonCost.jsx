// 물냉면편 썸네일 — 이거 얼마남아 13 (2026-08-03)
//
...
import { EP, cost, ratio } from "./card_naengmyeon";
...
export const 줄 = [
  { 글: "물냉면", 크기: 106, 좌우: -8, 위아래: -78, 색: "검정", 폰트: "굵게" },
...
const ARGS = { hook: HOOK, label: 리본글, food: DISH.물냉면, fit: false, 소품, 화살표, 쪽지,
...
// 썸네일 Still (배경 포함)
export const ThumbNaengmyeonCost = () => <ThumbLayout {...ARGS} />;

// 🔴 쇼츠 첫 장면(훅)용 — **배경 없이 알맹이만.** talk_engine 이 배경을 이미 깔았다.
//    썸네일과 같은 부품을 쓰므로 둘이 절대 어긋나지 않는다.
export const ThumbCardNaengmyeonCost = () => <ThumbInner {...ARGS} />;

// ── 인트로 장면 — 캐릭터 등장 ────────────────────────────────
export const NaengmyeonCostIntro = () => (
