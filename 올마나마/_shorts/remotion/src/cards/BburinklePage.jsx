// 뿌링클편 판 — 여성향 톤 (2026-07-25)
// 🔴 피자편(PizzaPage)과 골격은 같다. 색만 tone.js 를 따른다.
//    쇼츠는 BburinklePanel 만 떼어 쓰고, 스틸(BburinklePage)도 같은 걸 감싼다 → 화면이 갈라지지 않는다
...
import { PAGES } from "./pages_bburinkle";
...
export const BburinklePanel = ({ i = 0, top = 200, pop = 1 }) => (
  <Panel top={top} pop={pop}><Body p={PAGES[i] || PAGES[0]} /></Panel>
);

export const BburinklePage = ({ i = 0 }) => (
