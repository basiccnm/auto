...
import { PAGES } from "./pages_puradak";
...
export const PuradakPanel = ({ i = 0, top = 200, pop = 1 }) => (
  <Panel top={top} pop={pop}><Body p={PAGES[i] || PAGES[0]} /></Panel>
);

export const PuradakPage = ({ i = 0 }) => (
