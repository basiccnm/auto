// 순대국편 판 — 여성향 톤 (2026-07-29)
// 🔴 골격은 ZicobaPage와 같다. 색만 tone.js 를 따른다.
...
import { PAGES } from "./pages_keunmam";
...
export const KeunmamPanel = ({ i = 0, top = 200, pop = 1 }) => (
  <Panel top={top} pop={pop}><Body p={PAGES[i] || PAGES[0]} /></Panel>
);

export const KeunmamPage = ({ i = 0 }) => (
