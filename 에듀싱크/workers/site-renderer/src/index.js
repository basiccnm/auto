...
// 2026-08-10 대표님 확정: 체험은 **1주일**. 약관 제5조도 7일이다.
/* 🔴 2026-08-14 — 여기만 14 로 남아 있었다(주석엔 7 이라고 써 놓고 값은 14).
   그냥 «웹 등록 경로라 안 쓴다»가 아니다 — **크론의 개학일 체험 재부여**(scheduled)가
   같은 상수를 쓴다. 앱으로 등록한 아이도 개학일에 이 배치를 타므로,
   앱 7일 → 개학일에 14일로 덮이고 **약관(7일)과 어긋난 채** 나갈 뻔했다.
   ⚠ 체험 길이는 «앱 api_records.js TRIAL_DAYS» 와 **항상 같은 값**이어야 한다. */
const TRIAL_DAYS = 7;
